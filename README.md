...
Au démarrage de u-boot, on obtient le debut suivant :

```
Loading Environment from MMC... *** Warning - bad CRC, using default environment
```

Éléments de réponses ici : https://forums.developer.nvidia.com/t/bad-crc-in-fw-peintenv-on-tx2-sdk-32-4-3/166623/9

> **TODO** lors du prochain flash, tester :
...
Ou alors ici : https://stackoverflow.com/questions/73604585/checking-for-environment-crc-in-u-boot-script
...
> **TODO** Tester avec une debian plus récente (ici 11 bullseye -> 13 trixie)
...
1. Un accéléromètre est disponible sur la DE10-nano. De quel modèle s'agit-il ?

2. Écrivez un code utilisateur permettant d'afficher l'accélération en x, y et z dans le terminal.

C'est un TP projet, vous aurez pas mal de recherches à faire pour y arriver. Bon courage!